...
const Features = () => {
  return (
    <>
      <p
        className="mt-20 mb-5 border-2 border-dark-600 features"
        id="features"
      ></p>
      <div className="mt-10 ">
        <p className="text-xl mb-10 text-theme ">FEATURES</p>
        ...
        <div className="grid grid-cols-3 mt-10 gap-12">
          <button className="group p-10 text-start shadow-lg shadow-dark-secondary hover:pt-5 ">
            <p className="text-theme text-5xl">
            ...
            <p className="group-hover:visible invisible text-theme text-4xl pt-2">
